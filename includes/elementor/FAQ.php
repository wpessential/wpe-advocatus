...
class FAQ extends \Elementor\Widget_Base
{
    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            'question_1',
            [
                'label' => esc_html__('Question', 'wpe-advocatus'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Default heading', 'wpe-advocatus'),
                'placeholder' => esc_html__('Type your Question here', 'wpe-advocatus'),
            ]
        );
        ...
        $this->add_control(
            'answer_1',
            [
                'label' => esc_html__('Answer', 'wpe-advocatus'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'rows' => 10,
                'default' => esc_html__('Default description', 'wpe-advocatus'),
                'placeholder' => esc_html__('Type your Answer here', 'wpe-advocatus'),
            ]
        );
